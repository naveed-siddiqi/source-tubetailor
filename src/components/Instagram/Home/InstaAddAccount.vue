    ...
    <table-layout>
      <div class="pb-5 sm:flex sm:items-center sm:justify-between">
        ...
        <div class="mt-3 sm:ml-4 sm:mt-0">
          <button
            type="button"
            class="inline-flex items-center gap-2 px-3 py-2 text-sm font-semibold text-white rounded-full shadow-sm bg-insta focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
          >
            <div
      ...
      <div class="flex items-center gap-3">
        <img
          ...
          class="h-14 w-14 border-2 border-[#FFCF23] rounded-full"
          alt=""
        />
