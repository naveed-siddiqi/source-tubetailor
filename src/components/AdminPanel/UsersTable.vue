...
<template>
    <div class="md:col-span-3 grid grid-col-1 sm:grid-cols-3 gap-4">
        <div>
            <label class="text-lg text-gray-800 font-medium" for="filter">Search</label>
            <select
        ...
        <div>
            <label class="text-lg text-gray-800 font-medium" for="filter">Filter:</label>
            <select
                class="px-4 py-2.5 bg-white styleCard rounded-md col-span-1 md:col-span-3 shadow-sm border !border-gray-200"
                v-model="filter" id="filter">
        ...
        <div>
            <label class="text-lg text-gray-800 font-medium" for="filter">Sort By:</label>
            <select
                class="px-4 py-2.5 bg-white styleCard rounded-md col-span-1 md:col-span-3 shadow-sm border !border-gray-200"
                v-model="filter" id="filter">
                <option value="">List all users</option>
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="whitespace-nowrap px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
                                                    @click="sortBy('date')">Date</th>
                                                <th class="whitespace-nowrap px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
                                                    @click="sortBy('ordernumber')">Order Number</th>
                                                <th class="whitespace-nowrap px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
    ...
    data() {
        return {
            ...
            slides: [
                ...
                { name: 'February', content: 'Your slide 2 content here' },
            ],
            users: [
                { id: 1, date: '12-02-2024', ordernumber: '24', email: 'Hamzawattoo4321@gmail.com', country: 'USA', package: 'Pro', amount: '$123' },
                { id: 2, date: '12-02-2024', ordernumber: '24', email: 'Hamzawattoo4321@gmail.com', country: 'USA', package: 'Lite', amount: '$123' },
                { id: 2, date: '12-02-2024', ordernumber: '24', email: 'Hamzawattoo4321@gmail.com', country: 'USA', package: 'Lite', amount: '$123' },
                { id: 2, date: '12-02-2024', ordernumber: '24', email: 'Hamzawattoo4321@gmail.com', country: 'USA', package: 'Lite', amount: '$123' },
                { id: 3, date: '12-02-2024', ordernumber: '24', email: 'Hamzawattoo4321@gmail.com', country: 'USA', package: 'Basic', amount: '$123' },
                { id: 3, date: '12-02-2024', ordernumber: '24', email: 'Hamzawattoo4321@gmail.com', country: 'USA', package: 'Basic', amount: '$123' },
            ],
            sortKey: '',
            filter: '',
