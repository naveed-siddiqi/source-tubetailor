        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="space-y-4 md:col-span-1">
            ...
            <div class="p-6 bg-white rounded-xl bg-shadow">
              <div class="flex items-center justify-between">
                ...
                <div class="text-center">
                  ...
                  <span
                    class="px-2 py-1 lg:text-[16px] text-[14px] font-bold rounded-full bg-insta text-white"
                    >8.1/10</span
                  >
                </div>
              </div>
              <div class="min-w-full overflow-hidden">
                <div
                  class="flex overflow-x-auto example gap-8 py-6 items-center justify-between"
                >
                  <CircleProgress
                    startColor="#ff0000"
                    stopColor="#ffa500"
            ...
            <div class="p-4 space-y-2 bg-white rounded-xl bg-shadow">
              ...
              <div class="flex items-center justify-start gap-2">
                ...
                <button
                  ...
                  :class="[
                    'px-3 py-1.5 text-xs border rounded-full',
                    currentTab === 2
                      ? 'bg-insta text-white border-[#fe4442]'
                      : '',
                  ]"
                >
                  Result 2
              ...
              <div class="py-2">
                <label
                  class="text-[16px] w-full flex items-center justify-between font-semibold"
                  for="title"
              ...
              <div class="py-2">
                ...
                >
                  ...
                  <span
                    class="cursor-pointer"
                    v-clipboard="'Description copied'"
                    v-clipboard:success="onSuccess"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="space-y-6 md:col-span-1">
            ...
            <div class="px-6 py-8 space-y-4 bg-white bg-shadow rounded-xl">
                        ...
                        <div class="modal">
                          <div class="modal-title">
                            <div class="flex items-center gap-4 my-4 tools">
                              ...
                              <button
                                class="px-8 py-2 font-semibold text-white rounded-full crop-button bg-insta"
                                @click="cropImage"
                              >
                                Crop
                              </button>
              ...
              <div
                ...
                class="flex items-center justify-center w-[300px] mx-auto aspect-[4/5] overflow-x-hidden border border-gray-200 rounded shadow"
              >
              <div>
                  <div v-if="!loading">
                    <button
              ...
              <div class="flex items-center gap-2 font-semibold">
                <button
                  ...
                  :class="[
                    ...
                    elementsTab === 1 ? 'bg-insta text-white' : '',
                  ]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  ...
                  :class="[
                    'border shadow text-center flex items-center flex-col w-28 p-3  rounded-lg',
                    elementsTab === 2 ? 'bg-insta text-white' : '',
                  ]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  ...
                  :class="[
                    'border shadow text-center flex items-center flex-col w-28 p-3  rounded-lg',
                    elementsTab === 3 ? 'bg-insta text-white' : '',
                  ]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
