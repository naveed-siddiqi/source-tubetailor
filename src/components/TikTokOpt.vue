        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div class="p-6 bg-white rounded-xl bg-shadow">
              <div class="flex items-center justify-between">
                ...
                <div class="text-center">
                  ...
                  <span
                    class="px-2 py-1 lg:text-[16px] text-[14px] font-bold rounded-full bg-tiktok text-white"
                    >8.1/10</span
                  >
                </div>
              </div>
              <div class="min-w-full overflow-hidden">
                <div
                  class="flex overflow-x-auto example gap-8 items-center justify-between py-4"
                >
                  <CircleProgress
                    startColor="#ff004f"
                    stopColor="#2e6da4"
              ...
              <div class="flex items-center justify-start gap-2">
                ...
                <button
                  ...
                  :class="[
                    'px-3 py-1.5 text-xs border rounded-full',
                    currentTab === 2
                      ? 'bg-tiktok text-white border-[#fe4442]'
                      : '',
                  ]"
                >
                  Result 2
          ...
          <div class="space-y-6 md:col-span-1">
            ...
            <div class="px-6 py-8 space-y-4 bg-white bg-shadow rounded-xl">
              ...
              >
                <div class="">
                  <h1>This is really a cool thing</h1>
                </div>
                <div class="mb-4">
                  <div class="">
                    <section
                        ...
                        <div class="modal">
                          <div class="modal-title">
                            <div class="flex items-center gap-4 my-4 tools">
                              ...
                              <button
                                class="px-8 py-2 font-semibold text-white rounded-full crop-button bg-tiktok"
                                @click="cropImage"
                              >
                                Crop
                              </button>
              ...
              <div
                ...
                class="flex items-center justify-center w-[280px] mx-auto aspect-[9/16] border border-gray-200 rounded shadow"
              >
              <div>
                  <div v-if="!loading">
                    <button
              ...
              <div class="flex items-center gap-2 font-semibold">
                <button
                  ...
                  :class="[
                    ...
                    elementsTab === 1 ? 'bg-tiktok text-white' : '',
                  ]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  ...
                  :class="[
                    'border shadow text-center flex items-center flex-col w-28 p-3  rounded-lg',
                    elementsTab === 2 ? 'bg-tiktok text-white' : '',
                  ]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  ...
                  :class="[
                    'border shadow text-center flex items-center flex-col w-28 p-3  rounded-lg',
                    elementsTab === 3 ? 'bg-tiktok text-white' : '',
                  ]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
...
.custom-loader::before {
  ...
  background:linear-gradient(90deg, #ff004f 0%, #2e6da4 100%);
