...
<template>
  <div class="flex items-center justify-between">
    <div class="flex items-center gap-2">
      <select
        class="w-48 px-2 text-[13px] py-2 border border-gray-300 rounded shadow-sm outline-none"
        name=""
        id=""
      >
        <option v-for="font in fonts" :key="font" value="">{{ font }}</option>
      </select>
      <div class="inline-flex text-[13px]" role="group">
        <button
          type="button"
          class="inline-block rounded-l border-2 p-2 pb-[6px] pt-2 text-xs font-medium leading-normal transition duration-150 ease-in-out hover:bg-neutral-500 hover:bg-opacity-10 focus:outline-none focus:ring-0 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10"
          data-te-ripple-init
        ...
        <span
          type="button"
          class="-ml-0.5 inline-block border-2 px-6 pb-[6px] pt-2 text-xs font-medium leading-normal transition duration-150 ease-in-out hover:bg-neutral-500 hover:bg-opacity-10 focus:outline-none focus:ring-0 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10"
          data-te-ripple-init
          data-te-ripple-color="light"
          >{{ counter }}</span
        >
        <button
          type="button"
          @click="increment"
          class="-ml-0.5 inline-block rounded-r border-2 p-2 pb-[6px] pt-2 text-xs font-medium leading-normal transition duration-150 ease-in-out hover:bg-neutral-500 hover:bg-opacity-10 focus:outline-none focus:ring-0 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10"
          data-te-ripple-init
          data-te-ripple-color="light"
        >
          <svg
